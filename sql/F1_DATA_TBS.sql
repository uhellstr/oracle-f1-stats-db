...
--------------------------------------------------------
--  DDL for Table F1_OFFICIAL_WEATHER
--------------------------------------------------------
prompt "F1_OFFICIAL_WEATHER"
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index IN_F1_OFFICIAL_WEATHER
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  Constraints for Table F1_OFFICIAL_WEATHER
--------------------------------------------------------

  ALTER TABLE "F1_DATA"."F1_OFFICIAL_WEATHER" MODIFY ("YEAR" NOT NULL ENABLE);
  ALTER TABLE "F1_DATA"."F1_OFFICIAL_WEATHER" MODIFY ("RACE" NOT NULL ENABLE);
  ALTER TABLE "F1_DATA"."F1_OFFICIAL_WEATHER" MODIFY ("RACETYPE" NOT NULL ENABLE);
  ALTER TABLE "F1_DATA"."F1_OFFICIAL_WEATHER" MODIFY ("DATAPOINT" NOT NULL ENABLE);
